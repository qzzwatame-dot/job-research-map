...
- `fit/`: 20問で伸びる職場タイプ、相性が良い業界、企業TOP10を出すキャリア相性診断
...
`fit/` では、20問の診断から `成長戦略タイプ`、`安定構築タイプ`、`市場創造タイプ`、`専門深化タイプ`、`事業推進タイプ` などの結果を出し、相性が良い業界と企業TOP10を提示します。結果企業はPlannerの志望リストにも保存できます。
